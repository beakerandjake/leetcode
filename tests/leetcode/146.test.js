...
import { arrToStr } from '../util';

describe('146. LRU Cache', () => {
  [
    [2, ['put'], [[5, 10]], [undefined]],
    [
      2,
      ['put', 'get', 'put', 'get'],
      [[5, 10], [5], [5, 20], [5]],
  ...
  ].forEach(([capacity, funcs, args, expected]) => {
    test(`${capacity},${arrToStr(args)} -> ${arrToStr(expected)}`, () => {
      const cache = new LRUCache(capacity);
      funcs.forEach((func, i) => {
        const result = cache[func](...args[i]);

 ...
 *
 * Run-length encoding [http://en.wikipedia.org/wiki/Run-length_encoding] (RLE) is
 ...
 * example, to compress the string "3322251" we replace "33" with "23", replace
 * "222" with "32", replace "5" with "15" and replace "1" with "11". Thus the
